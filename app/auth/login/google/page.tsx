            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Role selection is only required for first-time Google sign-in. Existing users will use their stored
                  role automatically.
                </p>
              </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-yellow-700 mt-1">
                        Since this is your first time signing in with Google, please select a role above before
                        continuing.
                      </p>
                    </div>
                  </div>
